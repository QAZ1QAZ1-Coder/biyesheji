<template>
  <div style="padding-bottom: 10px">
    ...
    <div style="margin-bottom: 10px">
      <el-input style="width: 300px; margin-right: 5px" v-model="data.name" placeholder="请输入商品名称关键字查询" />
      <el-button type="primary" @click="load">搜索</el-button>
      <el-button type="info" style="margin: 0 10px" @click="reset">重置</el-button>
      <el-button type="primary" @click="handleAdd" style="float: right">新增农产品</el-button>
    </div>
