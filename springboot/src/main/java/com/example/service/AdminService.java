...
public class AdminService {
     ...
     */
    // 在 AdminService.java 的 login 方法中修改
    public Account login(Account account) {
        ...
        // 生成token
        String token = jwtTokenUtil.generateToken(dbAdmin.getId(), dbAdmin.getUsername(), "ADMIN");
        ...
        result.setAvatar(dbAdmin.getAvatar()); // 添加头像字段
    ...
    public void add(Admin admin) {
        ...
        if (ObjectUtil.isNotNull(dbAdmin)) {
            throw new CustomException("用户已存在"); // 修改错误信息
        }
